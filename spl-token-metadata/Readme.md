# Choice SPL
Folder for SPL Token MetaData. The goal is to add MetaData to the SPL token. As of 9/26/22, we have added an initial MetaData file to Choice Coin. Next, we will add an updated image file and complete a burn beofre launching the asset on Orca.
